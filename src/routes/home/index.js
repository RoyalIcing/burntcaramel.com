	...
	return (
		<main class={style.home}>
			...
			<Block>
				...
				<p>I now work at <a href="https://www.elevatepartners.com.au/">Elevate Partners</a>, a digital product consultancy. I also lead a range of open source projects, using Golang, Elixir, TypeScript & Swift, under the organisation <a href="https://github.com/RoyalIcing">@RoyalIcing</a>.</p>

				<nav class={style.linksNav}>
					<ul class={style.links}>
						<LinkItem
							href="https://www.dropbox.com/s/g8zii1ytk4sc8kw/Patrick%20Smith%20Resume.pdf?dl=0"
							iconName='paperclip'
						>
							Resume
						</LinkItem>
